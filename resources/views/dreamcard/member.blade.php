                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            ...
                            <a href="{{ route('cartwtb') }}/{{$group->slug}}" type="button" class="btn btn-warning"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp; WTB &nbsp; <span class="badge badge-pill badge-danger" id="countphotowtb">{{count((array) session('cartwtb')) }}</span></a>
