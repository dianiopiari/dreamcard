		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item">
					    <a href="{{config('app.url')}}/terms-condition" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Terms & Conditions </span></a>
					</li>
                </ul>
			</div>
		</div>
                ...
                <div class="row align-items-center">
					<div class="col-md-12">
						<div class="page-header-title">
                            ...
                            @else
                            <h5 class="m-b-10">Please <a href="{{ route('login') }}" style="color: aliceblue"><b>Login</b></a> first, if you want to use My Photocard & Wishlist feature</h5>
                            @endauth
						</div>
					</div>
				</div>
                            ...
                            @foreach($groups as $kb)
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <center>
                                            <a href="{{config('app.url')."/app/".$kb->slug }}" class="btn btn-info" role="button">View Group</a>
